    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reff.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(final DataSnapshot dataSnapshot) {
                ...
                for( int i = 1 ; i <= N ; i++ ){
                    arrayList.add(dataSnapshot.child(String.valueOf(i)).child("eleName").getValue(String.class));
                }
                ...
                mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                        ...
                        c.setFoodName(dataSnapshot.child(String.valueOf(i)).child("eleName").getValue(String.class));
                        ...
                        intent.putExtra("eleName",c.getFoodName());
